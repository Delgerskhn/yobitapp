...
void main() {
  group('routes', () {
    ...
    test('Route to signin if not authenticated', () async {
      // Use the `driver.getText` method to verify the counter starts at 0.
      final signinScreenFinder = dvr.find.byValueKey(IDs.SignInScreen);

      expect(await driver.getText(signinScreenFinder), findsOneWidget);
    });
  });
  // group('Counter App', () {
  ...
  //   test('Alert on wrong credentials', () async {
  //     // Use the `driver.getText` method to verify the counter starts at 0.
  ...
  //   test('Successfully route to home screen on valid credentials', () async {
